...
let firstString: String = "who"
let secondString: String = " am I"
let thirdString: String = firstString+secondString
...
//desired output = "$5.67"
let dollarsValue = numOfPennies/100
print("josie has \(dollarsValue).\(numOfPennies%100)")
...
var weeklyEarningsString = "On average, millenials spend \(averageRent/100)% of their income on rent."
/*:
 ****
 [Table of Contents](Table%20of%20Contents) | [Previous](@previous) | [Next](@next)
 */
